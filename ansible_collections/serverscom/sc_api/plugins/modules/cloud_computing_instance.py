...
DOCUMENTATION = """
---
module: cloud_computing_instance
version_added: "1.0.0"
...
options:
    ...
    region_id:
      ...
      description:
        ...
        - Use M(serverscom.sc_api.cloud_computing_regions_info) to get list
    ...
    ssh_key_fingerprint:
        ...
        description:
          ...
          - Fingerprint must be registered. Use M(serverscom.sc_api.ssh_key)
